...
export class Detect {
    ...
    parse(ua) {
        // Parsers Utility
        const parsers = (type) => {
            return this.regexes[type + '_parsers'].map((obj) => {
        ...
        // Set Browser
        let browser = find(ua, browser_parsers);
        if (check(browser)) {
            browser = {
                name: toString(browser),
        ...
        const mobile_agents = {};
        this.regexes.mobile_browser_families.map((str) => {
            mobile_agents[str] = true;
        });
        this.regexes.mobile_os_families.map((str) => {
            mobile_agents[str] = true;
        });
        // Is Spider
        ...
        device.manufacturer = browser.man || os.man || device.man || null;
        // Cleanup Objects
        remove([browser, os, device], ['tablet', 'man']);
